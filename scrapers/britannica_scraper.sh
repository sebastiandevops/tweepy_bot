...
sed -i 's/See All Biographies On This Day/See All Biographies On This Day\n/' data.txt
...
grep -v -e 'See All Biographies' -e 'born' "$dir"/processed3.txt | grep -vE '^.{,80}$' > "$dir"/processed4.txt
